...
tf.app.flags.DEFINE_string(
    'data_dir', '/datacentre/wuyang.zhang/300w_tfrecords_32_512_sin_blur_20190703/', 'Path to the directory containing data tf record.')
...
tf.app.flags.DEFINE_string(
    'model_dir', 'OCR_TF_CRNN_CTC_ckpt_20190709/', 'Base directory for the model.')
...
def _train_densenetocr_ctc():
    ...
    tfrecord_path = [os.path.join(FLAGS.data_dir, 'train_02.tfrecord')]
    ...
    # tfrecord_path = [ '/datacentre/wuyang.zhang/100w_tfrecords_20190624_skew/train.tfrecord' ]
    #char_map_dict = json.load(open(FLAGS.char_map_json_file, 'r'))
